...
Status getElement(LinkedList linkedList,int index,ListElementType &returnElement);
int  findElement(LinkedList,ListElementType element);
Status PriorElement(LinkedList linkedList,int index,ListElementType &returnElement);
Status NextElement(LinkedList linkedList,int index,ListElementType &returnElement);
Status insertElement(LinkedList &linkedList,int index,ListElementType element);
Status deleteElement(LinkedList &linkedList,int index,ListElementType &element);
/*=====================================函数声明=====================================*/
...
Status clearList(LinkedList &linkedList){
    if(linkedList == NULL){
        ...
        while(!isEmpty(linkedList)){
            deleteElement(linkedList, 0, temp);
        }
        return TRUE;
    }
}
...
*/
int  findElement(LinkedList linkedList,ListElementType element){
 ...
 * 返回值：插入结果
*/
Status insertElement(LinkedList &linkedList,int index,ListElementType newElement){
